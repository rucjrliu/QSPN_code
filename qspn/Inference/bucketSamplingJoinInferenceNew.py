from Structure.bucketSamplingJoinBaseNew import MultiQSPN, Table_Models_Partitions, Partition, CEtree_Node, enum_all_loc_no, intersection_selected_loc_no_forward, intersection_selected_loc_no_back
...
def partition_singletable_prob_calc(qspn, filtering_predicates, query_scope):
    if type(filtering_predicates) is tuple:
        ...
        return min(1.0, qspn.probability(filtering_predicates, query_scope))
    else:
