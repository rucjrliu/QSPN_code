...
def learn_FSPN(
    ...
    def learn_param(data, ds_context, cols, rows, queries, threshold, ohe, updateQSPN_scope, updateQSPN_workload_all_n, qdcorr, build_fjbuckets):
    ...
    print('\tohe:', ohe)
    #exit(-1)
    return learn_param(data, ds_context, cols, rows, queries, threshold, ohe, updateQSPN_scope, updateQSPN_workload_all_n, qdcorr, build_fjbuckets)
